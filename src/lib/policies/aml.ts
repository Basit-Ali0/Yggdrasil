// ============================================================
// AML Prebuilt Policy — 10 rules from knowledge/aml.md
// ============================================================
...
export const AML_RULES: Rule[] = [
    {
        ...
        is_active: true,
        description:
            'Flag transactions exceeding $10,000 CTR reporting threshold.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag when multiple transactions to same person aggregate > $10,000 in single day.',
    },
    {
        ...
        is_active: true,
        description:
            'Detect structuring/smurfing — multiple transactions $8K–$10K within 24 hours.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag 5+ sub-threshold transactions ($8K–$10K) in 24 hours.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag transactions >= $5K with suspicious patterns for SAR review.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag accounts with > $25K in 24-hour period.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag high-value transactions from dormant accounts.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag transactions where balance change doesn\'t match amount.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag 3+ round-dollar transactions ($X,000) within 30 days.',
    },
    {
        ...
        is_active: true,
        description:
            'Flag transactions to empty accounts (potential fraud).',
    },
    // HIGH_VALUE_TRANSFER is the 11th rule referenced in the rule coverage matrix
    // but aml.md lists 10 explicitly. It's in enforcement-spec so we include it.
];

// Add HIGH_VALUE_TRANSFER (11th rule from enforcement-spec)
AML_RULES.push({
    ...
    is_active: true,
    description:
        'Flag wire/transfer transactions > $50,000.',
});
